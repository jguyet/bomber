var Player = function(id, x, y)
{
	...
	this.print = function()
	{
		...
		// Sprite (42x42) centered on hitbox (14x14): offset = (14-42)/2 = -14
		// Vertically: align sprite bottom with hitbox bottom: offset = 14-42 = -28
		var frameW = this.img.image.width / this.img.fw;
		var frameH = this.img.image.height / this.img.fh;
		var offsetX = (14 - frameW) / 2;   // -14 for 42px sprite
		var offsetY = 14 - frameH;         // -28 for 42px sprite (feet at hitbox bottom)
	...
	this.getpos = function()
	{
		...
		var gx = Math.floor((this.x + 7) / 32);
		var gy = Math.floor((this.y + 7) / 32);
